...
svg(filename = "plots/for_article/f_3a_GO_enrichment_waterspecific_HVGs_saline.svg")
dotplot(saline_GO, showCategory = 30,
        title = "GO terms, saline_GO")
dev.off()
svg(filename = "plots/for_article/f_3b_GO_enrichment_waterspecific_HVGs_freshwater.svg")
...
svg(filename = "plots/for_article/f_3c_KEGG_enrichment_waterspecific_HVGs_freshwater.svg")
dotplot(saline_kegg,showCategory = 30,title = "KEGG terms, saline")
dev.off()
svg(filename = "plots/for_article/f_3d_GO_enrichment_waterspecific_HVGs_freshwater.svg")
