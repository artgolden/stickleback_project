---
title: "Bootstraping for analysis of varience in DIs"
...
# Matrix::writeMM(obj = comb_counts_matrix, file = "data/scATAC/cells_peaks_matrix_after_balancing_counts_by_watertype.mtx")
write.csv(as.data.frame(comb_counts_matrix), file = "data/scATAC/cells_peaks_matrix_after_balancing_counts_by_watertype.csv")
```
...
bootstraps_combined %>% 
  ...
  xlab("Divergence Island ID") %>% print()
dev.off()
```
