...
pdf(file = "plots/for_article/Suppl_scATAC_atac1_blood_clusters_identification.pdf", width = 15, height = 15)
...
pdf(file = "plots/for_article/Suppl_scATAC_atac2_blood_clusters_identification.pdf", width = 15, height = 15)
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac2_with_rna))
dev.off()
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac2_with_rna))
```
...
pdf(file = "plots/for_article/Suppl_scATAC_atac3_blood_clusters_identification.pdf", width = 15, height = 15)
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac3_with_rna))
dev.off()
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac3_with_rna))
```
...
pdf(file = "plots/for_article/Suppl_scATAC_atac4_blood_clusters_identification.pdf", width = 15, height = 15)
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac4_with_rna))
dev.off()
suppressWarnings(plot_gene_distribution(sample_name = "saline_1", sample_obj = atac4_with_rna))
```
...
```{r}
f.test.filtered <- saline_vs_freshwater_varience_table_filtered_downsampled_annotated
...
pdf(file = "plots/for_article/Suppl_scATAC_f_ratio_peaks_histogram_filtered_for_p_val.pdf")
p_f_ratio_blood
dev.off()
p_f_ratio_blood
```
...
```{r}
pdf(file = "plots/for_article/scATAC_f_ratio_peaks_unfiltered_for_p_val_histogram.pdf")
saline_vs_freshwater_varience_table %>% 
