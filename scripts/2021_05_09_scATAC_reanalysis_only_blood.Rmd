...
saline_vs_freshwater_varience_table_blood <- do.call(rbind,output)
saline_vs_freshwater_varience_table_blood %>% 
  dplyr::filter(p_val < 0.05 & f_ratio > 0 & f_ratio != Inf & p_val != 0) %>% 
  rownames_to_column(var = "peak") -> saline_vs_freshwater_varience_table_blood_blood_filtered_downsampled
...
saline_vs_freshwater_varience_table_blood_blood_filtered_downsampled_annotated <- inner_join(saline_vs_freshwater_varience_table_blood_blood_filtered_downsampled, peaks_in_combined_obj_annotated, by = c("peak" = "query_region"))

write_csv(saline_vs_freshwater_varience_table_blood_blood_filtered_downsampled_annotated, file = "data/scATAC/saline_vs_freshwater_BLOOD_varience_table_on_balanced_matrix_based_on_peaks_height_filtered.csv")
```
...
saline_vs_freshwater_varience_table_blood %>% 
  ...
  ylab("Number of peaks") -> p7
p7
pdf(file = "plots/for_article/Supple_scATAC_f_ratio_peaks_histogram_unfiltered_BLOOD_only.pdf")
p7
dev.off()
# paste0("AFTER downsampling, mean varience difference ratio: ", mean(saline_vs_freshwater_varience_table_blood_blood_filtered_downsampled$f_ratio))
```
